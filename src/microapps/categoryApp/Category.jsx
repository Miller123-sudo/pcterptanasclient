    ...
    const createDocument = (data) => {
        ...
        return ApiService.post('/department', data).then(response => {
            if (response.data.isSuccess) {
                navigate(`/${rootPath}/category/list`)
            }
        }).catch(e => {
                ...
                <Container fluid >
                    <Row>
                        <Col className='p-0 ps-2'>
                            <Breadcrumb style={{ fontSize: '24px', marginBottom: '0 !important' }}>
                                <Breadcrumb.Item className='breadcrumb-item' linkAs={Link} linkProps={{ to: `/${rootPath}/category/list` }}>   <div className='breadcrum-label'>CATEGORIES</div></Breadcrumb.Item>
                    ...
                    <Row style={{ marginTop: '-10px' }}>
                        <Col className='p-0 ps-1'>
                            ...
                            <Button as={Link} to={`/${rootPath}/category/list`} variant="secondary" size="sm">DISCARD</Button>
                    ...
                    <Row>
                        ...
                        <TextField
                            ...
                            field={{
                                ...
                                placeholder: "",
                                required: true,
                                validationMessage: "Please enter the category name!"
                            }}
                            changeHandler={null}
                            blurHandler={null}
                        />
                        ...
                        <SelectField
                            ...
                            errors={errors}
                            field={{
                                description: "Supervisor of the category",
                                label: "SUPERVISOR",
                                fieldId: "supervisor",
                                placeholder: "",
                                // required: true,
                        ...
                        <SelectField
                            ...
                            errors={errors}
                            field={{
                                description: "Parent category of the current category",
