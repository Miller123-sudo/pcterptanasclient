...
export default function StockAdjustmentPerProduct() {
        ...
        <Container className="pct-app-content-container p-0 m-0" fluid>
            <Container className="pct-app-content" fluid>
                <Container className="pct-app-content-header p-0 m-0 pb-2" fluid>
                    <Row>
                        <Col><h3>STOCK ADJUSTMENT PER PRODUCT</h3></Col>
                    </Row>
                    ...
                    <Row>
                        ...
                        <Form.Group as={Col} md="4" className="mb-2">
                            <Button onClick={handleSearchInvAdj} type="button" size="sm" variant="primary" style={{ marginTop: 23 }}>SEARCH</Button>
                            <Button onClick={handleExportAsCsv} variant="primary" size="sm" style={{ marginTop: 23 }}><span>Export CSV</span></Button>
                        </Form.Group>
