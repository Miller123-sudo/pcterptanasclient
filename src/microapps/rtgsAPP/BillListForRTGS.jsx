...
export default function BillListForRTGS() {
    ...
    const printRTGS = () => {
        ...
        if (selectedBill.length > 0) {
            PurchaseOrderPDF.generateRTGS(selectedBill)
                    ...
                    <Row>
                        <Col className='p-0 ps-2'>
                            <Breadcrumb style={{ fontSize: '24px', marginBottom: '0 !important' }}>
                                ...
                                <Breadcrumb.Item active> <div className='breadcrum-label-active'>PRINT RTGS</div></Breadcrumb.Item>
                    ...
                    <Row style={{ marginTop: '-10px' }}>
                        ...
                        <Col md="7" sm="8">
                            <Row>
                                ...
                                <Col md="2"><Button variant="primary" size="sm" onClick={printRTGS}><span>PRINT RTGS</span></Button></Col>{""}
                            </Row>
                        </Col>
                    </Row>
                </Container>
